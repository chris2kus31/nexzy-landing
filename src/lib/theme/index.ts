    ...
    tokens: {
      ...
      colors: {
        nexzy: {
          ...
          blue: { value: "#007BFF" }, // Bright blue from N
          lightBlue: { value: "#4DA3FF" }, // Light blue accent
          yellow: { value: "#FFD700" }, // Yellow/orange from circle
          gold: { value: "#FFC400" }, // Brighter gold variant
          white: { value: "#FFFFFF" },
          gray: {
            50: { value: "#F7FAFC" },
            100: { value: "#EDF2F7" },
