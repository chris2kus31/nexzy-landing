...
const DISPLAY = anton.style.fontFamily; // heavy title
const MONO = courier.style.fontFamily; // headings, info, body
...
// A glossy 90s-mag banner bar (blue gradient, gold notch, bevel).
const BAR_BLUE = "linear-gradient(180deg, #3E86E6, #1B4D9E)";
const BAR_GOLD = "linear-gradient(180deg, #FFD35A, #E0A21E)";
const BEVEL =
  "inset 0 1px 0 rgba(255,255,255,.35), inset 0 -2px 0 rgba(0,0,0,.28), 0 2px 0 rgba(0,0,0,.30)";
    ...
    >
      <Box px={{ base: 5, md: 8 }} py={{ base: 5, md: 7 }}>
        ...
        >
          ...
          >
            <Flex align="stretch" overflow="hidden" css={{ boxShadow: BEVEL }}>
              <Box w="7px" bg={GOLD} />
              <Text
                flex="1"
                px={{ base: 3, md: 4 }}
